...
class HtmlParser:
    ...
    @staticmethod
    def find_icd_section_title(html: str, icd10_code: str) -> str:
        ...
        matches = re.findall("(([a-zA-Z]+)([0-9]+))(\\..+)?", icd10_code)
    ...
    @staticmethod
    def _find_disease_in_section(parent_element, icd10_code: str) -> tuple:
        ...
        for sub_section in disease_sub_sections:
            ...
            if disease_line is not None:
                for ul in disease_line:
                    search_result = HtmlParser._find_disease_in_section(ul, icd10_code)
            ...
            if line_texts is None:
                ...
                pass
            elif icd10_code in line_texts[0].get_text():
    ...
    @staticmethod
    def find_disease_name_and_link(html: str, icd10_code: str) -> tuple:
        ...
        for section in disease_sections:
            article_link, article_title = HtmlParser._find_disease_in_section(section, icd10_code.upper())
